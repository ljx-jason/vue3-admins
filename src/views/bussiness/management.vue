<template>
  <div class="app-container">
    <div class="search-bar">
      <el-form ref="queryFormRef" :model="queryParams" :inline="true">
        <el-form-item prop="keywords" label="类型">
          <el-input v-model="queryParams.keywords" placeholder="类型" clearable @keyup.enter="handleQuery" />
        </el-form-item>
        <el-form-item prop="keywords" label="客群名称">
          <el-input v-model="queryParams.keywords" placeholder="客群名称" clearable @keyup.enter="handleQuery" />
        </el-form-item>
        <el-form-item>
    ...
    <el-card shadow="never">
      ...
      <el-table ref="dataTableRef" v-loading="loading" v-autoHeight="90" :data="roleList" highlight-current-row border
        ...
        <el-table-column fixed="right" label="操作" width="320">
          <template #default="scope">
            <el-button type="success" size="small" link icon="CircleCheck" @click="handleOpenDialog(scope.row.id)">
              启动
            </el-button>
            <el-button type="warning" size="small" link icon="Warning" @click="handleOpenDialog(scope.row.id)">
              结束
            </el-button>
            <el-button type="danger" size="small" link icon="CircleClose" @click="handleOpenDialog(scope.row.id)">
              作废
            </el-button>
            <el-button type="primary" size="small" link icon="Notification" @click="handleOpenDialog(scope.row.id)">
              详情
            </el-button>
            <el-button type="primary" size="small" link icon="memo" @click="handleOpenAssignPermDialog(scope.row)">
              客户清单
            </el-button>
          </template>
        </el-table-column>
